...
public abstract class Character extends Item
{
    ...
    public static final int DEFAULT_CHARACTER_WIDTH  = 256;   /*!< Latimea implicita a imaginii caracterului.*/
    public static final int DEFAULT_CREATURE_HEIGHT = 256;   /*!< Inaltimea implicita a imaginii caracterului.*/
    ...
    public void MoveX()
    {
        ...
        if(x+xMove < refLink.GetWidth()-DEFAULT_CHARACTER_WIDTH/2 && x+xMove > 0)
        {
            x += xMove;
        }
    }
